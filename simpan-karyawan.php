...
if (empty($nama) || empty($jabatan) || empty($tanggal_masuk) || empty($no_hp)) {
...
//query insert data ke dalam database (perbaiki nama tabel dari tbl_karyawan menjadi karyawan)
$query = "INSERT INTO karyawan (nama, jabatan, tanggal_masuk, no_hp) VALUES ('$nama', '$jabatan', '$tanggal_masuk', '$no_hp')";
...
if ($connection->query($query)) {
    ...
    <body>
        <div class='alert-container'>
            ...
            <p>Data karyawan <strong>$nama</strong> telah berhasil ditambahkan ke database.</p>
    ...
    //pesan error gagal insert data dengan detail error
    echo "
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class='alert-container'>
            ...
            <p>Terjadi kesalahan saat menyimpan data karyawan.</p>
            <div class='error-details'>
                <strong>Error Detail:</strong><br>
                " . $connection->error . "
            </div>
            <div>
                <a href='tambah-karyawan.php' class='btn btn-secondary'>
